...
result = cv2.drawMatches(training_image, train_keypoints, image2, test_keypoints, matches, image2, flags = 2)


plt.rcParams['figure.figsize'] = [14.0, 7.0]
plt.title('Full Matching Points')
plt.imshow(result)
plt.show()
...
result = cv2.drawMatchesKnn(training_image,train_keypoints, image2,test_keypoints, good, None, flags = 2)

plt.rcParams['figure.figsize'] = [14.0, 7.0]
plt.title('Knn Maching')
plt.imshow(result)
plt.show()
